...
class Sim(VoxCadParams):
    ...
    def __init__(self, self_collisions_enabled=True, simulation_time=10.5, dt_frac=0.9, stop_condition=2,
                 ...
                 max_elastic_mod=5e008, afterlife_time=0, mid_life_freeze_time=0, damp_evolved_stiffness=True):
...
class Env(VoxCadParams):
    ...
    def __init__(self, frequency=40.0, gravity_enabled=1, grav_acc=-27.468, density=1e+006, temp_enabled=1,
                 floor_enabled=1, floor_slope=0.0, lattice_dimension=0.001, fat_stiffness=1e+007, bone_stiffness=50e+006,
                 muscle_stiffness=1e+007, sticky_floor=0, time_between_traces=0, save_passive_data=False,
